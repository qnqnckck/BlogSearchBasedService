...
class RankingRepository(
    ...
    fun getSearchKeywordRank(size: Int): List<RankingKeywordItem> {
        val zSetOperations = redisTemplate.opsForZSet()
        val typedTuples = zSetOperations.reverseRangeWithScores(RANKING_KEYWORD_REDIS_KEY, 0, (size-1).toLong())  // score순으로 10개 보여줌
